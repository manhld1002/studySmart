...
)
{
    ...
    var selectedSubject by remember { mutableStateOf("No Subject Selected") } // State to hold selected subject
    ...
    DeleteDialog(
        ...
        title = "Delete Task ?",
        bodyText = "Are you sure, you want to delete this task ? " + "This action can not be undo",
        onDismissRequest = {
