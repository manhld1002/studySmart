...
import vn.miagi.studysmart.util.pad
...
class StudySessionTimerService : Service()
{
    ...
    var duration: Duration = Duration.ZERO
        private set
    // these values can only be written in this file, outside it only can be read
    ...
    {
        // Specify notification's channel for specific notification
    ...
    )
    {
        ...
        timer = fixedRateTimer(initialDelay = 1000L, period = 1000L) {
            // Update the duration per 1 seconds
